                ...
                <div className="bg-white rounded-lg shadow p-6">
                    ...
                    <form className='space-y-4' onSubmit={handleSaveProfile}>
                        ...
                        <div>
                            ...
                            <input type="text" name="" id="" className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Enter your full name' onChange={(e) => setEditForm({ ...editForm, full_name: e.target.value })} value={editForm.full_name} />
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="" id="" className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Enter your username' onChange={(e) => setEditForm({ ...editForm, username: e.target.value })} value={editForm.username} />
                        </div>
                        {/* Bio  */}
                        <div>
                            <label className='block text-sm font-medium text-gray-700 mb-1'>
                            ...
                            <textarea rows={3} name="" id="" className='resize-none w-full p-3 border border-gray-200 rounded-lg' placeholder='Enter bio' onChange={(e) => setEditForm({ ...editForm, bio: e.target.value })} value={editForm.bio} />
                        </div>
                        {/* Location  */}
                        <div>
                            <label className='block text-sm font-medium text-gray-700 mb-1'>
                            ...
                            <input type='text' name="" id="" className='resize-none w-full p-3 border border-gray-200 rounded-lg' placeholder='Enter location' onChange={(e) => setEditForm({ ...editForm, location: e.target.value })} value={editForm.location} />
                        </div>
